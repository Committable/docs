			...
			resultsFooterComponent={() => (
				<div style={{ marginBlock: '2em' }}>
					...
					<ul style={{ display: 'flex', gap: '1em', marginBlock: '0.5em', flexWrap: 'wrap' }}>
						<li>
							<a href="https://committable.io/integrations/">{labels.resultsFooterIntegrations}</a>
						</li>
						<li>
							<a href="https://committable.io/themes/">{labels.resultsFooterThemes}</a>
						</li>
						<li>
							<a href="https://committable.io/chat">{labels.resultsFooterDiscord}</a>
						</li>
					</ul>
				</div>
			)}
