...
# Instead, change this file: https://github.com/Committable/astro/blob/main/packages/astro/src/%40types/astro.ts
# Translators, please remove this note and the <DontEditWarning/> component. 

title: Configuration Reference
i18nReady: true
githubURL: https://github.com/Committable/astro/blob/main/packages/astro/src/%40types/astro.ts
---
...
export async function run() {
	const inputBuffer =
		STUB ||
		(await fetch(
			'https://raw.githubusercontent.com/Committable/astro/main/packages/astro/src/%40types/astro.ts'
		).then((r) => r.text()));
